...
public class ArrangementWork {
    ...
    public ReactAgent mainAgent() {
        return ReactAgent.builder()
                ...
                - writerArticleAgent：专业写作专家，擅长创作中文文章、散文、诗歌等
                ...
                - 如果需要调用专家，输出一个 JSON 数组，列出要调用的专家名称，例如：
                  ["writerArticleAgent"]
                  或
                  ["writerArticleAgent", "translator_agent"]
                ...
                示例：
                用户：写一篇关于春天的短文
                你输出：["writerArticleAgent"]
                
                用户：写一篇短文并翻译成英文
                第一步：["writerArticleAgent"]
    ...
    public SupervisorAgent supervisorAgent(
        ...
        return SupervisorAgent.builder()
                ...
                .subAgents(List.of(writerArticleAgent, translatorAgent))
                .build();
    }
}
